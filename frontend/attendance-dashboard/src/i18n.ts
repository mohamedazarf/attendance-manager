...
const resources = {
  en: {
    translation: {
      ...
      "Ce departement systeme ne peut pas etre supprime": "Ce departement systeme ne peut pas etre supprime",
      "Configuration": "Configuration",
      "Confirmation : Choisir la stratégie de suppression": "Confirmation : Choisir la stratégie de suppression",
      ...
      "Enregistrer ces horaires (Ramadhan)": "Enregistrer ces horaires (Ramadhan)",
      "Erreur": "Erreur",
      "Erreur d'enregistrement": "Erreur d'enregistrement",
      "Erreur lors de l'enregistrement des horaires de ramadhan": "Erreur lors de l'enregistrement des horaires de ramadhan",
      "Erreur lors de l'enregistrement des horaires normaux": "Erreur lors de l'enregistrement des horaires normaux",
      "Erreur lors de la creation du departement": "Erreur lors de la creation du departement",
      "Erreur lors de la récupération des utilisateurs": "Erreur lors de la récupération des utilisateurs",
      "Erreur lors de la suppression du departement": "Erreur lors de la suppression du departement",
      ...
      "Impossible de supprimer l'utilisateur": "Impossible de supprimer l'utilisateur",
      "Inclure automatiquement le dimanche comme non ouvrable": "Inclure automatiquement le dimanche comme non ouvrable",
      ...
      "Rôle": "Role",
      "Supprimer": "Supprimer",
      "Supprimer définitivement tous les employés": "Supprimer définitivement tous les employés",
      ...
      "Veuillez remplir le nom et les horaires": "Veuillez remplir le nom et les horaires",
      "admin_arfaoui": "admin_arfaoui",
      "date": "date",
      "email@example.com": "email@example.com",
      "filter": "filter",
      "{{count}} employe(s) supprime(s).": "{{count}} employee(s) deleted.",
      "{{dept}} : entrée {{start}} - sortie {{end}}": "{{dept}} : entry {{start}} - exit {{end}}",
      "Êtes-vous sûr de vouloir supprimer cet utilisateur ?": "Are you sure you want to delete this user?",
      "admin": "Admin",
      "simple_user": "Simple User",
      "En ramadhan, la pause est automatiquement fixée à 0 minute.": "During Ramadan, the break is automatically set to 0 minutes.",
      "Êtes-vous certain de vouloir supprimer \"{{department}}\" ? Cette action est irréversible.": "Are you certain you want to delete \"{{department}}\"? This action is irreversible.",
  ...
  fr: {
    translation: {
      ...
      "{{dept}} : entrée {{start}} - sortie {{end}}": "{{dept}} : entrée {{start}} - sortie {{end}}",
      ...
      "En ramadhan, la pause est automatiquement fixée à 0 minute.": "En ramadhan, la pause est automatiquement fixée à 0 minute.",
      "Êtes-vous certain de vouloir supprimer \"{{department}}\" ? Cette action est irréversible.": "Êtes-vous certain de vouloir supprimer \"{{department}}\" ? Cette action est irréversible.",
