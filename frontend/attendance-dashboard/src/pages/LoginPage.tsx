...
const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const userResponse = await fetch('http://localhost:8000/api/v1/roles/me', {
                headers: {
    ...
    //         if (!userResponse.ok || userData.detail) {
    //             // Si le backend renvoie "Could not validate credentials"
    //             throw new Error(userData.detail || 'Failed to fetch user profile');
    //         }

    //         // 3. Stockage des données propres
    //         login(data.access_token, userData);
